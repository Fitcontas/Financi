...
$.extend( true, $.fn.dataTable.defaults, {
    "sDom": "<'row'<'col-sm-24 no-padding'<'pull-right'f><'pull-left'l>r<'clearfix'>>>t<'row'<'col-sm-24 no-padding'<'pull-left'i><'pull-right'p><'clearfix'>>>",
    ...
    "aoColumnDefs": [
            { "bSortable": false, "sWidth": "22px", "aTargets": [ 0 ]},
            { "bSortable": true, "sWidth": "80px", "aTargets": [ 3 ]}
    ],
...
$.extend( $.fn.dataTableExt.oPagination, {
	"bs_normal": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).append(
				'<ul class="pagination">'+
					'<li class="prev disabled"><a href="#"><span class="fa fa-angle-left"></span>&nbsp; Anterior</a></li>'+
					'<li class="next disabled"><a href="#">Próximo &nbsp;<span class="fa fa-angle-right"></span></a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
