        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div ng-show="aba == 2">
                    ...
                    <div class="form-group no-margin-bottom">
                        <label class="col-sm-6 control-label" for="contrato[primeiro_vencimento]">Primeiro Vencimento</label>
                        <div class="col-sm-9">
                            <div class="input-group date">
