        ...
        <div id="si-reg" class="content" style="display: block">
            ...
            <div class="block-flat">
                ...
                <div class="content spacer0 process">
                    <div class="toobar">
                        <div class="pull-left">
                        <div class="btn-group pull-left" id="buttons-grid"><div class="btn-group no-margin">    <button type="button" data-toggle="dropdown" class="btn btn-default  dropdown-toggle no-margin" action="no">        Novo&nbsp;<span class="caret"></span>    </button>    <ul role="menu" class="dropdown-menu">    <li> <a href="/cliente/cadastro/pf" class="no">Cliente PF</a></li>    <li> <a href="/cliente/cadastro/pj" class="no">Cliente PJ</a></li>    </ul></div><button type="button" class="btn btn-default " action="excluir"> Excluir</button><button type="button" class="btn btn-default " action="habilitar"> Habilitar</button><button type="button" class="btn btn-default " action="desabilitar"> Desabilitar</button></div>
                        </div>
