...
<div class="cl-mcont" ng-cloak>
    ...
    <div ng-controller="FormEmpreendimentoCtrl" ng-cloak>
                ...
                <div id="si-reg" class="content" style="display: block">
                    ...
                    <div ng-show="(model.empreendimentos.length && model.$resolved) || model.busca">
                        <div class="content spacer0 process">
                            ...
                            <div class="table-responsive" ng-show="!model.empreendimentos.length && model.$resolved && model.busca">
        ...
        <!-- Modal -->
        <div role="dialog" id="empreendimento_modal" class="colored-header md-effect-10 md-show modal" aria-hidden="false"><!-- Modal -->
